...
import lwctrans
from lwctrans.imageio.natural_image_reager_writer import NaturalImage2DIO
from lwctrans.imageio.nibabel_reader_writer import NibabelIO, NibabelIOWithReorient
from lwctrans.imageio.simpleitk_reader_writer import SimpleITKIO
from lwctrans.imageio.tif_reader_writer import Tiff3DIO
...
def recursive_find_reader_writer_by_name(rw_class_name: str) -> Type[BaseReaderWriter]:
    ret = recursive_find_python_class(join(lwctrans.__path__[0], "imageio"), rw_class_name, 'nnunetv2.imageio')
    if ret is None:
