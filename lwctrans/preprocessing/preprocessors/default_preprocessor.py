...
from lwctrans.paths import nnUNet_preprocessed, nnUNet_raw
from lwctrans.preprocessing.cropping.cropping import crop_to_nonzero
from lwctrans.preprocessing.resampling.default_resampling import compute_new_shape
...
class DefaultPreprocessor(object):
    ...
    def _normalize(self, data: np.ndarray, seg: np.ndarray, configuration_manager: ConfigurationManager,
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(join(lwctrans.__path__[0], "preprocessing", "normalization"),
                                                           scheme,
