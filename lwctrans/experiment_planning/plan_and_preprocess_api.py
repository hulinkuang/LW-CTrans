...
from lwctrans.experiment_planning.dataset_fingerprint.fingerprint_extractor import DatasetFingerprintExtractor
from lwctrans.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
from lwctrans.experiment_planning.verify_dataset_integrity import verify_dataset_integrity
from lwctrans.paths import nnUNet_raw, nnUNet_preprocessed
from lwctrans.utilities.dataset_name_id_conversion import convert_id_to_dataset_name, maybe_convert_to_dataset_name
from lwctrans.utilities.find_class_by_name import recursive_find_python_class
from lwctrans.utilities.plans_handling.plans_handler import PlansManager
from lwctrans.configuration import default_num_processes
from lwctrans.utilities.utils import get_filenames_of_train_images_and_targets
...
def extract_fingerprints(dataset_ids: List[int], fingerprint_extractor_class_name: str = 'DatasetFingerprintExtractor',
    ...
    """
    fingerprint_extractor_class = recursive_find_python_class(join(lwctrans.__path__[0], "experiment_planning"),
