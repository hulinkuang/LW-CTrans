...
from lwctrans.configuration import ANISO_THRESHOLD, default_num_processes
from lwctrans.evaluation.evaluate_predictions import compute_metrics_on_folder
from lwctrans.inference.export_prediction import export_prediction_from_logits, resample_and_save
from lwctrans.inference.predict_from_raw_data import nnUNetPredictor
from lwctrans.inference.sliding_window_prediction import compute_gaussian
from lwctrans.paths import nnUNet_preprocessed, nnUNet_results
from lwctrans.training.data_augmentation.compute_initial_patch_size import get_patch_size
from lwctrans.training.data_augmentation.custom_transforms.cascade_transforms import MoveSegAsOneHotToData, \
    ApplyRandomBinaryOperatorTransform, RemoveRandomConnectedComponentFromOneHotEncodingTransform
from lwctrans.training.data_augmentation.custom_transforms.deep_supervision_donwsampling import \
    DownsampleSegForDSTransform2
from lwctrans.training.data_augmentation.custom_transforms.limited_length_multithreaded_augmenter import \
    LimitedLenWrapper
from lwctrans.training.data_augmentation.custom_transforms.masking import MaskTransform
from lwctrans.training.data_augmentation.custom_transforms.region_based_training import \
    ConvertSegmentationToRegionsTransform
from lwctrans.training.data_augmentation.custom_transforms.transforms_for_dummy_2d import Convert2DTo3DTransform, \
    Convert3DTo2DTransform
from lwctrans.training.dataloading.data_loader_2d import nnUNetDataLoader2D
from lwctrans.training.dataloading.data_loader_3d import nnUNetDataLoader3D
from lwctrans.training.dataloading.nnunet_dataset import nnUNetDataset
from lwctrans.training.dataloading.utils import get_case_identifiers, unpack_dataset
from lwctrans.training.logging.nnunet_logger import nnUNetLogger
from lwctrans.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from lwctrans.training.loss.deep_supervision import DeepSupervisionWrapper
from lwctrans.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from lwctrans.training.lr_scheduler.polylr import PolyLRScheduler
from lwctrans.utilities.collate_outputs import collate_outputs
from lwctrans.utilities.default_n_proc_DA import get_allowed_n_proc_DA
from lwctrans.utilities.file_path_utilities import check_workers_alive_and_busy
from lwctrans.utilities.get_network_from_plans import get_network_from_plans
from lwctrans.utilities.helpers import empty_cache, dummy_context
from lwctrans.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
from lwctrans.utilities.plans_handling.plans_handler import PlansManager, ConfigurationManager
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, outpath: str, fold: int, dataset_json: dict,
        ...
        self.output_folder = join(self.output_folder_base, outpath, f'fold_{fold}')
        print(f"Results save to: {self.output_folder}")
        ...
        self.print_to_log_file("\n#######################################################################\n"
                               "Thanks nnU-Net\n"
                               "LW-CTrans is modified based on nnUNetv2.\n"
                               "#######################################################################\n",
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            self.network = self.build_network_architecture(self.plans_manager, self.dataset_json,
                                                           ...
                                                           use_nnunet=self.use_nnunet).to(self.device)
    ...
    def build_network_architecture(plans_manager: PlansManager,
                                   ...
                                   use_nnunet: bool = False) -> nn.Module:
        """
    ...
    def _get_deep_supervision_scales(self):
        ...
        # deep_supervision_scales.insert(0, [1., 1.])
