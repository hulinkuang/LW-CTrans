...
from lwctrans.preprocessing.resampling.utils import recursive_find_resampling_fn_by_name
from torch import nn

import lwctrans
from batchgenerators.utilities.file_and_folder_operations import load_json, join

from lwctrans.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from lwctrans.utilities.find_class_by_name import recursive_find_python_class
from lwctrans.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
if TYPE_CHECKING:
    from lwctrans.utilities.label_handling.label_handling import LabelManager
    from lwctrans.imageio.base_reader_writer import BaseReaderWriter
    from lwctrans.preprocessing.preprocessors.default_preprocessor import DefaultPreprocessor
    from lwctrans.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
...
class ConfigurationManager(object):
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(join(lwctrans.__path__[0], "preprocessing"),
...
class PlansManager(object):
    ...
    def experiment_planner_class(self) -> Type[ExperimentPlanner]:
        ...
        experiment_planner = recursive_find_python_class(join(lwctrans.__path__[0], "experiment_planning"),
                                                         planner_name,
